...
import { findClosestPoint, convertBezier, myGetBezierValue, myGetValue, vecEqual, vecLength, vecSub } from './convert.js'
...
export function cutBezierPath (slicedBezierPath, type = 1, segment = 20) {
    ...
    do {
        ...
        for (let i = 1; i < indices.length; i++) {
            ...
            // if (Math.hypot(p0, p1) < 1e2 || Math.hypot(p2, p3) < 1e2) {
